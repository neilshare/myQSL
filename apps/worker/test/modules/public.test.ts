...
describe("public card projection", () => {
  it("rejects fuzzy lookup and does not expose private fields", async () => {
    const fuzzy = await exports.default.fetch("https://example.test/api/v1/public/card-lookup", { method: "POST", headers, body: JSON.stringify({ call: "BG4", qso_date: "20260903" }) });
