...
describe("Canonical API Contracts", () => {
  ...
  it("verifies all canonical OpenAPI routes are mounted and active (no 404 route drift)", async () => {
    ...
    const routesToTest = [
      ...
      { path: "/api/v1/cards/nonexistent", method: "GET", auth: true },
      ...
      { path: "/api/v1/imports", method: "POST", auth: true, body: { file_name: "test.adi", file_sha256: "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855", total_records: 0 } },
      { path: "/api/v1/imports/nonexistent", method: "GET", auth: true },
      { path: "/api/v1/imports/nonexistent/chunks", method: "POST", auth: true, body: { chunk_index: 0, checksum: "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855", idempotency_key: "k1", records: [] } },
      { path: "/api/v1/imports/nonexistent/complete", method: "POST", auth: true },
