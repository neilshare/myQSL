...
| T08 | partial | agent settings plus Owner review inbox API/UI, printing and delivery pages/routes | Review list/dismiss is implemented; no full inbox/selection/preview E2E |
